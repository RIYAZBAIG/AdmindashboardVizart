...
function EditUser() {
  ...
  const submitHandler = async(event) => {
    ...
    try {
      const info = JSON.stringify({...newUser,role: +newUser.role});
          ...
          <div className="wrapper">
            ...
            <div className="main-panel" data={color}>
              ...
              <div className="content mainContentDiv">
                {/* <Link to="/editUser" >
                <button class="btn btn-warning animation-on-hover" type="button">EditUser</button>
                </Link> */}
                <div className="card">
  ...
  <div className="col-md-6" style={{marginTop:"50px"}}>
    ...
    <select
      ...
      onChange={(e) => handleInputChange(e)}
    >
      <option value="1">Andrel Russel</option>
      <option value="2">M.S. Dhoni</option>
      <option value="3">V. S Laxman</option>
    </select>
  </div>
